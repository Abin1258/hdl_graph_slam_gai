...
public:
  ...
  void load(ParamServer& params) {
    use_const_inf_matrix = params.template param<bool>("hdl_graph_slam/use_const_inf_matrix", false);
    const_stddev_x = params.template param<double>("hdl_graph_slam/const_stddev_x", 0.5);
    const_stddev_q = params.template param<double>("hdl_graph_slam/const_stddev_q", 0.1);

    var_gain_a = params.template param<double>("hdl_graph_slam/var_gain_a", 20.0);
    min_stddev_x = params.template param<double>("hdl_graph_slam/min_stddev_x", 0.1);
    max_stddev_x = params.template param<double>("hdl_graph_slam/max_stddev_x", 5.0);
    min_stddev_q = params.template param<double>("hdl_graph_slam/min_stddev_q", 0.05);
    max_stddev_q = params.template param<double>("hdl_graph_slam/max_stddev_q", 0.2);
    fitness_score_thresh = params.template param<double>("hdl_graph_slam/fitness_score_thresh", 2.5);
  }
