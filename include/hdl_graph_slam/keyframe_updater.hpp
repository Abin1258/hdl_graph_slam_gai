...
public:
  ...
  KeyframeUpdater(ros::NodeHandle& pnh) : is_first(true), prev_keypose(Eigen::Isometry3d::Identity()) {
    keyframe_delta_trans = pnh.param<double>("hdl_graph_slam/keyframe_delta_trans", 2.0);
    keyframe_delta_angle = pnh.param<double>("hdl_graph_slam/keyframe_delta_angle", 2.0);
