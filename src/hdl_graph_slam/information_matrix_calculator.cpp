...
InformationMatrixCalculator::InformationMatrixCalculator(ros::NodeHandle& nh) {
  use_const_inf_matrix = nh.param<bool>("hdl_graph_slam/use_const_inf_matrix", false);
  const_stddev_x = nh.param<double>("hdl_graph_slam/const_stddev_x", 0.5);
  const_stddev_q = nh.param<double>("hdl_graph_slam/const_stddev_q", 0.1);

  var_gain_a = nh.param<double>("hdl_graph_slam/var_gain_a", 20.0);
  min_stddev_x = nh.param<double>("hdl_graph_slam/min_stddev_x", 0.1);
  max_stddev_x = nh.param<double>("hdl_graph_slam/max_stddev_x", 5.0);
  min_stddev_q = nh.param<double>("hdl_graph_slam/min_stddev_q", 0.05);
  max_stddev_q = nh.param<double>("hdl_graph_slam/max_stddev_q", 0.2);
